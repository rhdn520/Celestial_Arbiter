class GPTHandler {
  constructor(_globalVar, _promptText, _receiptPromptText) {
    ...
    this.judgment_schema = {
      ...
      "properties": {
        "judge_summary_kr": { "type": "string", "description": "The summary of a judge's sentence in korean." },
        "judge_summary_en": { "type": "string", "description": "The summary of a judge's sentence in english." },
        "value1_kr": { "type": "string", "description": "The first element of the list of five important values that the soul pursued in korean." },
        "value2_kr": { "type": "string", "description": "The second element of the list of five important values that the soul pursued in korean." },
        "value3_kr": { "type": "string", "description": "The third element of the list of five important values that the soul pursued in korean." },
        "value4_kr": { "type": "string", "description": "The fourth element of the list of five important values that the soul pursued in korean." },
        "value5_kr": { "type": "string", "description": "The fifth element of the list of five important values that the soul pursued in korean." },
        "value1_en": { "type": "string", "description": "The first element of the list of five important values that the soul pursued in english." },
        "value2_en": { "type": "string", "description": "The second element of the list of five important values that the soul pursued in english." },
        "value3_en": { "type": "string", "description": "The third element of the list of five important values that the soul pursued in english." },
        "value4_en": { "type": "string", "description": "The fourth element of the list of five important values that the soul pursued in english." },
        "value5_en": { "type": "string", "description": "The fifth element of the list of five important values that the soul pursued in english." },
